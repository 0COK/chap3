...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /* 목차 1. Scanner 객체 생성 */
        Scanner sc = new Scanner(System.in); // 스캐너를 만들었다는 것
...
//        System.out.println("입력하신 키는 " + heigh + "cm 입니다.");
//
//        /* nextDouble() : 입력받은 값을 double 형으로 반환한다. */
//        System.out.printㅁ("원하는 실수를 입력하세요 : ");
...
//        System.out.println("입력하신 실수는 " + number + "입니다.");
        ...
        boolean isTrue = sc.nextBoolean();                                             // 줄바꿈이 남아있어서 sc.넥스트라인을 쓴것이다(\n)
        System.out.println("입력하신 논리 값은 " + isTrue + "입니다.");

        /* 목차 2-5. 문자형 값 입력받기 */
        sc.nextLine();                                           // 버퍼에 남아있던 데이터를 지워줘야함
        System.out.print("아무 문자나 입력 해주세요 : ");
        char ch = sc.nextLine().charAt(0);                      // 0번째 인덱스 처음부분이구나
